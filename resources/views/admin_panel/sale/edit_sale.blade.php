                    ...
                    <div class="row g-2 align-items-end w-100 m-0">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-2">
                            ...
                            <select class="form-select" id="agentSelect" name="agent_id" style="width:100%">
                                ...
                                @foreach ($agents as $agent)
                                    <option value="{{ $agent->id }}" {{ ($sale->agent_id ?? null) == $agent->id ? 'selected' : '' }}>{{ $agent->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="d-none">
                            <select class="form-select fw-bold" id="partyTypeSelect" name="partyType">
                                <option value="Main Customer" {{ !$sale->walkin_name ? 'selected' : '' }}>Main Customer</option>
                                <option value="Walking Customer" {{ $sale->walkin_name ? 'selected' : '' }}>Walking Customer</option>
                            </select>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-8 col-lg-3">
                            <div class="d-flex justify-content-between align-items-center mb-1">
                                ...
                                <div class="btn-group" role="group" id="partyTypeToggle">
                                    <input type="radio" class="btn-check" name="partyTypeUI" id="typeMain" value="Main Customer" {{ !$sale->walkin_name ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary px-2 py-1 fw-bold" for="typeMain" style="font-size: 0.75rem;">Main</label>

                                    <input type="radio" class="btn-check" name="partyTypeUI" id="typeWalkin" value="Walking Customer" {{ $sale->walkin_name ? 'checked' : '' }}>
                        ...
                        <div class="d-flex flex-column h-100 gap-3">
                            ...
                            <div class="summary-card">
                                ...
                                <div class="summary-row" id="commissionInputRow">
                                    <span class="text-muted d-flex align-items-center gap-2">
                                        ...
                                        <span class="btn-group btn-group-sm" role="group" id="commissionTypeToggle">
                                            <input type="radio" class="btn-check" name="commission_type" id="commTypePercent" value="percent" {{ ($sale->commission_type ?? 'percent') === 'percent' ? 'checked' : '' }}>
                                            <label class="btn btn-outline-primary px-2 py-0 fw-bold" for="commTypePercent" style="font-size:0.65rem;">%</label>
                                            <input type="radio" class="btn-check" name="commission_type" id="commTypeFixed" value="fixed" {{ ($sale->commission_type ?? '') === 'fixed' ? 'checked' : '' }}>
                                            <label class="btn btn-outline-primary px-2 py-0 fw-bold" for="commTypeFixed" style="font-size:0.65rem;">Rs</label>
                                        </span>
                                    </span>
                                    <input type="number" step="0.01" min="0" id="commissionValue" name="commission_value" class="form-control form-control-sm text-end fw-bold" style="width: 90px; height: 26px; font-size: 0.75rem;" placeholder="0.00" value="{{ $sale->commission_value ?? '' }}">
                                </div>
                                <div class="summary-row" id="commissionDisplayRow">
                                    ...
                                    <span class="fw-bold text-success text-end" id="tCommission">{{ isset($sale->commission_amount) ? number_format($sale->commission_amount ?? 0, 2) : '0.00' }}</span>
                                </div>
                                <div class="summary-row">
