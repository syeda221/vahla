...
<div class="sale-report-container">
    ...
    <div id="ledgerBox" style="display:none;">
        ...
        <div class="print-header d-none d-print-block">
            <h2 id="printVendorNameTitle">VENDOR NAME</h2>
        ...
        <div class="print-meta-info d-none d-print-flex">
            <div>
                Account No: - <br>
                <span id="printVendorNameSubtitle" style="text-transform: uppercase;">ALL VENDORS</span>
            </div>
...
@section('js')
    <script>
        $(document).ready(function() {
            ...
            const storageKey = 'vendorLedgerReportFilters';
            ...
            if (isReset) {
                ...
                if (savedStr) {
                    ...
                    if (saved.vendor_id) $(".vendorSelect").val(saved.vendor_id).trigger('change');
            ...
            function loadLedger() {
                ...
                $.get("{{ route('report.vendor.ledger.fetch') }}", {
                    ...
                    let vendNameTitle = res.vendor.name === 'all' || !res.vendor.name ? 'ALL VENDORS' : res.vendor.name;
                    $("#printVendorNameTitle").text(vendNameTitle);
                    $("#printVendorNameSubtitle").text(vendNameTitle);
